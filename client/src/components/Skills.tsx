...
const skillCategories: SkillCategory[] = [
  {
    ...
    skills: ["N8N", "Make", "API Evolution", "Integração com APIs", "Webhooks", "WhatsApp Automation", "VPS", "EasyPanel"],
  ...
  },
  {
    ...
    skills: ["HTML5", "CSS3", "JavaScript", "TypeScript", "React", "React Router", "Tailwind CSS", "Vite", "Chart.js"],
