...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Faixa "Desenvolveu soluções para" */}
      <div className="max-w-[1240px] mx-auto relative z-10 mt-14">
        <Reveal>
        ...
        <Reveal>
          ...
          >
            <div className="flex w-max gap-22 items-center animate-fc-marquee-slow" style={{ gap: "88px" }}>
